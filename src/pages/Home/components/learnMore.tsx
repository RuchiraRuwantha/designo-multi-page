...
const LearnMore = () => {
    ...
    return (
        <div className="bg-[#E7816B] w-full sm:rounded-md relative overflow-hidden flex flex-col lg:flex-row justify-start sm:px-0 px-5 sm:pt-0 pt-16">
            ...
            <div className="lg:max-w-5xl z-10 lg:pl-28 2xl:py-32 lg:py-12 sm:px-16 sm:py-10 text-center lg:text-left">
            ...
            <div className="flex justify-center">
                <div className="relative overflow-hidden lg:block flex justify-center">
                    <img src={phone} alt="Phone Mockup" className="lg:block hidden overflow-hidden w-full h-full object-cover lg:pl-0 pl-10" />
